...
window.AKADEMIA.parent = {
  ...
  sections: [
    ...
    },
    {
      ...
      html: '<p>Regulamin ChatGPT wymaga ukończonych 13 lat, a OpenAI pisze wprost, że usługa nie jest przeznaczona dla młodszych dzieci i że w ich przypadku rozmowę powinien prowadzić dorosły. Kontrola rodzicielska ChatGPT dotyczy tylko kont nastolatków 13-17, dla 10-latka nie ma osobnej ścieżki. Dlatego Akademia zakłada: <strong>Twoje konto, Ty w pobliżu, Ty odpowiadasz za to, co się dzieje w czacie.</strong></p>' +
        '<p>Ustawienia, które warto zrobić raz, przed misją 0:</p>' +
        '<ol>' +
        '<li><strong>Osobny projekt dla dziecka.</strong> W ChatGPT utwórz Projekt, np. "Akademia", i w jego ustawieniach pamięci wybierz opcję pamięci tylko w obrębie projektu ("Project-only memory"). Czaty dziecka nie mieszają się wtedy z Twoimi i nie wpływają na to, co ChatGPT pamięta o Tobie. Dziecko zaczyna każdą misję nowym czatem wewnątrz tego projektu. <a href="https://help.openai.com/en/articles/10169521-using-projects-in-chatgpt" target="_blank" rel="noopener">Jak działają Projekty</a>.</li>' +
        '<li><strong>Alternatywa: czat tymczasowy.</strong> Przycisk "Tymczasowy" w nowym czacie. Rozmowa nie trafia do historii ani do pamięci. Minus: dziecko nie wróci do wcześniejszej rozmowy. <a href="https://help.openai.com/en/articles/8914046-temporary-chat-faq" target="_blank" rel="noopener">Czat tymczasowy</a>.</li>' +
        ...
        '</ol>' +
        '<p><strong>Gemini i Claude</strong> pojawiają się w misji 9, do porównania. Gemini ma tryb dla dzieci poniżej 13 lat przez Family Link, ale nie w Europejskim Obszarze Gospodarczym, więc w Polsce to nie działa. Claude wymaga 18 lat. W obu przypadkach: Twoje konto, Ty obok, kilka minut.</p>' +
        '<p>Niezależne wskazówki: Common Sense Media zaleca dla dzieci 6-12 lat ograniczone używanie chatbotów, zawsze razem z rodzicem, i odradza używanie AI jako wsparcia emocjonalnego u osób poniżej 18 lat. <a href="https://www.commonsensemedia.org/articles/ai-chatbots-and-your-child-age-and-stage-guidance" target="_blank" rel="noopener">Wskazówki Common Sense Media</a>.</p>'
    },
    {
